...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('kio_inventory_stocks', function (Blueprint $table) {
            $table->primary(["item_id", "batch_number"]);
            $table->uuid('item_id');
    ...
    {
        // Schema::table('kio_inventory_stocks', function (Blueprint $table) {
        //     $table->dropUnique('item_batch_unique');
        //   });
        Schema::dropIfExists('kio_inventory_stocks');
    }
};
