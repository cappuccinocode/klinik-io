...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Doctor Schedules</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="card-body">
            @include('admission.doctorScheduleTable')
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#doctorScheduleTable thead tr:eq(1) th').each( function () {
            var title = $(this).text();
        ...
        // Apply the search
        $('#doctorTable thead').on('keyup', ".column_search",function () {
            table
